...
class memory_main:
    ...
    def __init__(self, hasFile, fileSize, chunkSize):
        """
    ...
    def add_neighbor(self, name, chunks):
        ...
        """
        self._neighbors[name] = mem_File(0, self._fileSize, self._chunkSize, chunks)
    ...
    def update_neighbor(self, name, indexes, chunks):
        ...
        """
        self._neighbors[name].update(indexes, chunks)
    ...
    def interest(self, neighbor):
        ...
        """
        return list(set(self._bitMap.havePieces()) - set(self._neighbors[neighbor].havePieces()))
